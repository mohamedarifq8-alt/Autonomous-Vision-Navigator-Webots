...
* **Debug Windows:** Two windows will appear displaying the raw camera feed and the binary AI mask, allowing real-time monitoring of the robot's visual processing.
